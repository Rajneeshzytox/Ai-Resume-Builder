...
export default function ResumeBuilder() {
  ...
  const [resumeData, setResumeData] = useState({
    ...
    skill: ["html", "css", "js", "react basic", "php", "mysql", "c c++"],
  });
  ...
  const changePersonal = (e) => {
    ...
    setResumeData({
      ...resumeData,
      personalData: { ...resumeData.personalData, [name]: value },
    });
  };
  ...
  return (
    <>
        ...
        <div className="hero-content text-center">
          ...
          <div className="absolute left-0 top-[10%] flex gap-4 items-center justify-between px-10">
            <span
              ...
              data-tip="go back"
            >
              <a href="/" className="kbd kbd-md ">
                {"cd .."}
              </a>
            </span>
            <span className=" px-4 py-1 text-sm rounded-btn">
              <span className="kbd kbd-sm rounded-sm bg-transparent">/</span>{" "}
              resume-builder
            </span>
          </div>
          <div className="max-w-md">
            <h1 className="text-5xl font-bold bg-clip-text bg-gradient-to-r to-blue-400 from-primary text-transparent">
              Resume Sample
            </h1>
            <p className="py-6">
              This is not a official builder, but will give you a idea about the
              product
            </p>
            <a
              href="#resume-builder"
              className="tooltip tooltip-bottom tooltip-primary scroll-smooth"
      ...
      {IsAlert ? (
        <div
          id="tempAlert-layoutMsg"
          role="alert"
          className=" flex justify-between text-secondary alert my-4 w-[96%] mx-auto ring"
        >
          <div>
            <h3 className="font-bold">looks boring?</h3>
            <div className="text-xs font-semibold">Don't Judge a book by its cover, this is just a sample, we have more
            amazing features and design, coming soon...</div>
          </div>
      ...
      <section
        id="resume-builder"
        className="min-h-screen flex flex-col-reverse md:flex-row relative"
      >
